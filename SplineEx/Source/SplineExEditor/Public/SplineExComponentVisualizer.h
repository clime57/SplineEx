...
class SPLINEEXEDITOR_API FSplineExComponentVisualizer : public FComponentVisualizer
{
public:
	FSplineExComponentVisualizer();
	virtual ~FSplineExComponentVisualizer();
	...
	USplineExComponent* GetEditedSplineComponent() const;
